...
const SECTIONS = [
  {
    ...
    agents: [
      ...
      { code: 'UP', name: 'Actualizar Datos', subtitle: 'Subir facturas · banco · TGManager', icon: '📥', color: '#eab308', path: '/upload', desc: 'Sube facturas, extractos y exports. La IA los analiza y clasifica automáticamente.' },
    ]
  },
  {
